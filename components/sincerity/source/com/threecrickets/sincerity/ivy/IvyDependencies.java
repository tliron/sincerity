...
public class IvyDependencies extends Dependencies<IvyResolvedDependency>
{
	...
	@Override
	public ResolvedDependencies<IvyResolvedDependency> getResolvedDependencies() throws SincerityException
	{
		if( resolvedDependencies == null )
			resolvedDependencies = new IvyResolvedDependencies( this );
	...
	public Set<Artifact> getArtifacts( boolean install, boolean overwrite, boolean verify ) throws SincerityException
	{
		...
		ManagedArtifacts managedArtifacts = getManagedArtifacts();
	...
	public void freeze() throws SincerityException
	{
		...
		for( IvyResolvedDependency resolvedDependency : getResolvedDependencies() )
	...
	public void install( boolean overwrite, boolean verify ) throws SincerityException
	{
		...
		if( container.hasChanged() )
		{
			...
			getManagedArtifacts().prune( getArtifacts( true, overwrite, verify ) );
	...
	private IvyResolvedDependencies resolvedDependencies;

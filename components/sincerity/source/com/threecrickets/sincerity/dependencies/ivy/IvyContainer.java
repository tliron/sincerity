...
import com.threecrickets.sincerity.dependencies.ivy.internal.ExtendedResolutionCacheManager;
import com.threecrickets.sincerity.exception.SincerityException;

/**
 * @author Tal Liron
 */
public class IvyContainer extends Container<IvyModule, IvyRepositories> implements IvyListener, TransferListener
{
	//
	// Construction
	//
	...
	@Override
	public Dependencies<IvyModule> getDependencies()
	{
		return dependencies;
	}

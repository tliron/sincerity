...
public class Python
{
	...
	public Object call( String method, String... args ) throws ParsingException, ExecutionException, NoSuchMethodException
	{
	...
	private synchronized Executable getExecutable()
	{
		if( this.executable == null )
		{
			DocumentFileSource<Executable> source = new DocumentFileSource<Executable>( baseDir, "default", null, 1000 );
